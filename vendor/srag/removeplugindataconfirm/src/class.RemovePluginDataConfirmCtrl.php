...
namespace srag\RemovePluginDataConfirm\TPMS;
...
use ilSession;
use ilUtil;
use srag\DIC\TPMS\DICStatic;
use srag\DIC\TPMS\DICTrait;

/**
 * Class RemovePluginDataConfirmCtrl
 *
 * @package           srag\RemovePluginDataConfirm\TPMS
 *
 * @author            studer + raimann ag - Team Custom 1 <support-custom1@studer-raimann.ch>
 *
 * @ilCtrl_isCalledBy srag\RemovePluginDataConfirm\TPMS\RemovePluginDataConfirmCtrl: ilUIPluginRouterGUI
 */
class RemovePluginDataConfirmCtrl
{
