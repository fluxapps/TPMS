...
```php
use srag\DIC\TPMS\x\DICStatic;use srag\Plugins\x\x\x;DICStatic::dic()->database()->createAutoIncrement(x::TABLE_NAME, "id");
```
...
```php
...
use srag\DIC\TPMS\x\Version\PluginVersionParameter;
...
