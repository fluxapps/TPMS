...
/**
 * Class ilTPMSConfigGUI
 *
 * Generated by SrPluginGenerator v1.3.5
 *
 * @author studer + raimann ag - Team Custom 1 <support-custom1@studer-raimann.ch>
 */
class ilTPMSConfigGUI extends ilPluginConfigGUI
{
    ...
    protected function setTabs()/*: void*/
    {
        ...
        self::dic()->locator()->addItem(ilTPMSPlugin::PLUGIN_NAME, self::dic()->ctrl()->getLinkTarget($this, self::CMD_CONFIGURE));
    }
    ...
    protected function configure()/*: void*/
    {
        ...
        $form = self::TPMS()->config()->factory()->newFormInstance($this);
